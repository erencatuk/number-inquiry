...
<head>
    <meta charset="UTF-8">
    <title>Numara Temizleme İsteği</title>
...
<script>
  ...
  menuToggle.addEventListener('click', function(){
    ...
    <div class="container">
        <h2 style="text-align: center;">Numara Kaldırma Talebi</h2>
        <form action="deletebasarili.php" method="post">
            ...
            <label for="reason">Gerekçeniz</label>
            <input type="text" name="reason" id="reason" planeceholder="Lütfen geçerli bir sebep giriniz. Başka şekilde talebiniz geçerli görülmeyecektir." maxlength="255" require>
